...
url : String
url =
    "https://testproj1-5fbcf.firebaseio.com/AnswerPicks"
...
port runSet =
    Signal.map (\str -> set (string str) (fromUrl url)) inputString.signal
    ...
    in
        div []
            ...
            , div []
                ...
                [ button [ onClick inputString.address (addTo (String.slice 1 ((String.length outputText) - 1) outputText) 3) ] [ text "Submit" ] ]
            , div []
                [ label []
                    [ text "query result: "
